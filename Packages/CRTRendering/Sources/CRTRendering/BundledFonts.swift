...
/// Monospace fonts shipped with the app — SIL OFL 1.1, license texts sit
/// beside the files in Fonts/. Registered with process scope: usable
...
public enum BundledFonts {
    ...
    public static let families = ["Geist Mono", "Departure Mono"]
